...
<template>
    <div class=" w-full lg:inline-block hover:bg-gray-300 p-2 px-4 lg:pr-6 rounded-full cursor-pointer transition duration-200 ease-in-out">
        <div class="flex items-center">
            <component :is="icon" fillColor="#000000" :size="30" />
            <span class="lg:block hidden text-black font-extrabold text-[23px] pl-4 mt-0.5">
                {{ iconString }}
            </span>
        </div>
    </div>
